...
<head>
    ...
    <style>
        ...
        .active-sidebar-item {
            ...
            color: #E63946;
            opacity: 1;
            box-shadow: 0 10px 15px -3px rgba(230, 57, 70, 0.1);
        }
    </style>
</head>
<body class="font-poppins bg-gray-50 text-gray-900 min-h-screen">
        ...
        <aside id="sidebar" class="w-60 bg-gradient-to-b from-gray-900 to-red-600 text-white h-screen fixed transition-custom z-50 shadow-2xl shadow-red-500/10 flex flex-col overflow-hidden">
            <div class="flex items-center justify-center h-16 bg-red-500 transition-custom shadow-lg shadow-red-500/20">
                <div class="flex items-center gap-2.5 text-white font-bold text-lg tracking-wide transition-custom">
                    <img src="assets/logo.png" alt="MerchFlow Logo" class="w-8 h-8 rounded-lg shadow-lg bg-white object-contain" />
            ...
            <div class="flex-1 py-5 overflow-y-auto transition-custom">
                ...
                <a href="index.php" class="flex items-center gap-3 px-5 py-3 mx-2 text-white no-underline transition-custom rounded-xl font-medium text-base opacity-90 hover:bg-red-500/25 hover:text-red-500 hover:opacity-100 hover:shadow-lg hover:shadow-red-500/10 <?php echo $current_page === 'index.php' ? 'active-sidebar-item' : ''; ?>">
                ...
                <div class="module-dropdown">
                    <div class="module-toggle flex items-center gap-3 px-5 py-3 mx-2 text-white no-underline transition-custom rounded-xl font-medium text-base opacity-90 hover:bg-red-500/25 hover:text-red-500 hover:opacity-100 hover:shadow-lg hover:shadow-red-500/10 cursor-pointer <?php echo strpos($current_page, 'smart_warehousing') !== false ? 'active-sidebar-item' : ''; ?>">
                ...
                <div class="module-dropdown">
                    <div class="module-toggle flex items-center gap-3 px-5 py-3 mx-2 text-white no-underline transition-custom rounded-xl font-medium text-base opacity-90 hover:bg-red-500/25 hover:text-red-500 hover:opacity-100 hover:shadow-lg hover:shadow-red-500/10 cursor-pointer <?php echo strpos($current_page, 'procurement_sourcing') !== false ? 'active-sidebar-item' : ''; ?>">
                ...
                <div class="module-dropdown">
                    <div class="module-toggle flex items-center gap-3 px-5 py-3 mx-2 text-white no-underline transition-custom rounded-xl font-medium text-base opacity-90 hover:bg-red-500/25 hover:text-red-500 hover:opacity-100 hover:shadow-lg hover:shadow-red-500/10 cursor-pointer <?php echo strpos($current_page, 'project_logistic_tracker') !== false ? 'active-sidebar-item' : ''; ?>">
                ...
                <div class="module-dropdown">
                    <div class="module-toggle flex items-center gap-3 px-5 py-3 mx-2 text-white no-underline transition-custom rounded-xl font-medium text-base opacity-90 hover:bg-red-500/25 hover:text-red-500 hover:opacity-100 hover:shadow-lg hover:shadow-red-500/10 cursor-pointer <?php echo strpos($current_page, 'asset_lifecycle_maintenance') !== false ? 'active-sidebar-item' : ''; ?>">
                ...
                <div class="module-dropdown">
                    <div class="module-toggle flex items-center gap-3 px-5 py-3 mx-2 text-white no-underline transition-custom rounded-xl font-medium text-base opacity-90 hover:bg-red-500/25 hover:text-red-500 hover:opacity-100 hover:shadow-lg hover:shadow-red-500/10 cursor-pointer <?php echo strpos($current_page, 'document_tracking_logistic_record') !== false ? 'active-sidebar-item' : ''; ?>">
                ...
                <!-- Analytics & Reports -->
                <a href="analytics.php" class="flex items-center gap-3 px-5 py-3 mx-2 text-white no-underline transition-custom rounded-xl font-medium text-base opacity-90 hover:bg-red-500/25 hover:text-red-500 hover:opacity-100 hover:shadow-lg hover:shadow-red-500/10 <?php echo $current_page === 'analytics.php' ? 'active-sidebar-item' : ''; ?>">
                    <i class="fas fa-chart-line w-5 text-center text-lg"></i>
                    <span class="menu-text">Analytics</span>
                </a>
                <a href="reports.php" class="flex items-center gap-3 px-5 py-3 mx-2 text-white no-underline transition-custom rounded-xl font-medium text-base opacity-90 hover:bg-red-500/25 hover:text-red-500 hover:opacity-100 hover:shadow-lg hover:shadow-red-500/10 <?php echo $current_page === 'reports.php' ? 'active-sidebar-item' : ''; ?>">
            ...
            <nav class="h-16 bg-white shadow-lg shadow-red-500/10 px-6 flex items-center justify-between sticky top-0 z-40 border-b border-gray-200 backdrop-blur-sm">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-2">
                        <img src="assets/logo.png" alt="MerchFlow Logo" class="w-7 h-7 rounded-lg shadow-md bg-white object-contain" />
    ...
    <script>
        ...
        // Auto-expand active module dropdowns
        document.addEventListener('DOMContentLoaded', function() {
            const activeDropdowns = document.querySelectorAll('.module-toggle.active-sidebar-item');
            activeDropdowns.forEach(dropdown => {
                const submenu = dropdown.closest('.module-dropdown').querySelector('.module-submenu');
                const arrow = dropdown.querySelector('.dropdown-arrow');
                if (submenu) {
